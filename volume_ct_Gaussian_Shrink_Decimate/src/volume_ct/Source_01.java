...
public class Source_01 implements Source {
    ...
    private static final double MVOLUME = 7238.23;

    public Source_01(int gray, int ngauss, int nshrink, int ndec) {
        ...
        v16.SetFilePrefix("C:\\Users\\IMG_1\\Desktop\\QRM_04mmCTno_linepairs\\obj01\\obj01_");
        v16.SetFilePattern("%s%.3d.raw");
        v16.SetImageRange(0, 51);
        ...
        if (ngauss == 0) {
//            gauss.SetStandardDeviation(1, 1, 1);
            gauss.SetRadiusFactors(1.0, 1.0, 1.0);
        } else if (ngauss == 1) {
//            gauss.SetStandardDeviation(0.5, 0.5, 0.5);
